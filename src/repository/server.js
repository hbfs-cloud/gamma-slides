...
export async function serveRepositoryPresentation(directory,{port=4173,terminal=false,browser=false,cwd=process.cwd()}={}) {
  ...
  const shell=terminalHandler({enabled:terminal,cwd}),web=browserHandler({enabled:browser});
