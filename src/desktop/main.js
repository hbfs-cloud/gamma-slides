...
async function applyTemplate(id) {
  ...
  state.source = template.source; state.sourcePath = null; state.sourceKind = template.sourceKind; state.title = template.deckTitle; state.theme = template.themeName; state.currentIndex = 0; state.dirty = true; state.recoveryRestored = false; state.editRevision += 1; state.error = null; state.renderState = 'rendering';
