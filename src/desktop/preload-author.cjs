...
contextBridge.exposeInMainWorld('gammaDesktop', {
  ...
  restoreRevision: id => ipcRenderer.invoke('presenter:restore-revision', id),
  setCorporateProfile: profile => ipcRenderer.invoke('presenter:set-corporate-profile', profile),
  applyCorporateProfile: profile => ipcRenderer.invoke('presenter:apply-corporate-profile', profile),
  ...
  backupToGoogleDrive: () => ipcRenderer.invoke('presenter:google-backup'),
  connection: (action, options) => ipcRenderer.invoke('presenter:connection', action, options),
  flushSource: source => ipcRenderer.invoke('presenter:flush-source', source),
  openPublicUrl: url => ipcRenderer.invoke('presenter:open-public-url', url),
  ...
  resolveOperatorAction: (id, approved) => ipcRenderer.invoke('presenter:operator-action', id, approved),
