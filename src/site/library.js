...
const releaseUrl = `${repositoryUrl}/releases/tag/v2.0.1`;
const macDownloadUrl = `${repositoryUrl}/releases/latest/download/Gamma.Presenter-2.0.1-arm64-mac.zip`;
