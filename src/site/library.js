...
const releaseUrl = `${repositoryUrl}/releases/tag/v2.0.2`;
const macDownloadUrl = `${repositoryUrl}/releases/latest/download/Gamma.Presenter-2.0.2-arm64-mac.zip`;
