...
function addLibraryReturn(html, homeHref) {
  ...
  return closingBody < 0 ? `${withFavicon}${control}` : `${withFavicon.slice(0, closingBody)}${control}${withFavicon.slice(closingBody)}`;
}
