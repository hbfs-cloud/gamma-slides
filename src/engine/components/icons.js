...
const icons = {
  ...
  'wallet': '<path d="M19 7V4a1 1 0 0 0-1-1H5a3 3 0 0 0 0 6h14v12H5a3 3 0 0 1-3-3V6"/><path d="M16 13h3"/>',
  'banknote': '<rect width="20" height="12" x="2" y="6" rx="2"/><circle cx="12" cy="12" r="2"/><path d="M6 12h.01M18 12h.01"/>',
  'percent': '<line x1="19" x2="5" y1="5" y2="19"/><circle cx="6.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/>',
  'activity': '<path d="M22 12h-4l-3 9L9 3l-3 9H2"/>',
  'line-chart': '<path d="M3 3v18h18"/><path d="m7 16 4-5 4 3 5-7"/>',
  'pie-chart': '<path d="M21 12c.552 0 1.005-.449.95-.998a10 10 0 0 0-8.953-8.953C12.449 1.995 12 2.448 12 3v8a1 1 0 0 0 1 1z"/><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/>',
  'candlestick': '<path d="M9 5v4"/><rect width="4" height="6" x="7" y="9" rx="1"/><path d="M9 15v4M17 3v3"/><rect width="4" height="8" x="15" y="6" rx="1"/><path d="M17 14v7"/>',
  ...
  'scale': '<path d="m16 16 3-8 3 8a5 5 0 0 1-6 0M2 16l3-8 3 8a5 5 0 0 1-6 0M7 21h10M12 3v18M3 7h18"/>',
  ...
  'video': '<path d="m16 13 5 3V8l-5 3"/><rect width="14" height="14" x="2" y="5" rx="2"/>',
  'file-check': '<path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5z"/><polyline points="14 2 14 8 20 8"/><path d="m9 15 2 2 4-4"/>',
...
export function getIcon(name, color = 'currentColor', size = 20) {
